...
const firebaseConfig = {
  ...
  authDomain: "betweensystems-blog.firebaseapp.com",
  projectId: "betweensystems-blog",
  storageBucket: "betweensystems-blog.firebasestorage.app",
...
if (process.env.NODE_ENV === 'production') {
  try {
    ...
    const appCheck = initializeAppCheck(app, {
      provider: new ReCaptchaV3Provider('6LdT6KArAAAAALJhlY-vD4FYEldkjpHdz-qK5Cef'),
