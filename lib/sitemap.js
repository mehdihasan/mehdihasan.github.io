...
${posts.map(post => `  <url>
    ...
    <news:news>
      <news:publication>
        <news:name>DataDreamscape</news:name>
...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/"
  ...
  <channel>
    <title>DataDreamscape - Adventures in Northern Europe</title>
    <link>${baseUrl}</link>
    ...
    <image>
      <url>${baseUrl}/datadreamscape/logo.svg</url>
      <title>DataDreamscape</title>
      <link>${baseUrl}</link>
      <width>144</width>
      <height>144</height>
    </image>
${posts.map(post => `    <item>
      ...
      <dc:creator><![CDATA[DataDreamscape]]></dc:creator>
...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <author>
    <name>DataDreamscape</name>
    <uri>${baseUrl}</uri>
  </author>
  <rights>© ${new Date().getFullYear()} DataDreamscape</rights>
  <logo>${baseUrl}/datadreamscape/logo.svg</logo>
  <icon>${baseUrl}/datadreamscape/favicon.ico</icon>
