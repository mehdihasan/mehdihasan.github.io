...
${posts.map(post => `  <url>
    ...
    <news:news>
      <news:publication>
        <news:name>BetweenSystems</news:name>
...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/"
  ...
  <channel>
    <title>BetweenSystems - Where technology meets curiosity</title>
    <link>${baseUrl}</link>
    <description>Exploring the art and engineering of modern technology — from systems and software to data, people, and the ideas that connect them.</description>
    ...
    <image>
      <url>${baseUrl}/betweensystems/logo.svg</url>
      <title>BetweenSystems</title>
      <link>${baseUrl}</link>
      <width>144</width>
      <height>144</height>
    </image>
${posts.map(post => `    <item>
      ...
      <description><![CDATA[${post.excerpt || post.content?.slice(0, 300) || 'Where technology meets curiosity ...'}]]></description>
      <pubDate>${new Date(post.date || Date.now()).toUTCString()}</pubDate>
      <guid isPermaLink="true">${baseUrl}/${post.slug}</guid>
      <dc:creator><![CDATA[BetweenSystems]]></dc:creator>
...
<feed xmlns="http://www.w3.org/2005/Atom">
  ...
  <id>${baseUrl}/</id>
  <subtitle>Exploring the art and engineering of modern technology</subtitle>
  <author>
    <name>BetweenSystems</name>
    <uri>${baseUrl}</uri>
  </author>
  <rights>© ${new Date().getFullYear()} BetweenSystems</rights>
  <logo>${baseUrl}/betweensystems/logo.svg</logo>
  <icon>${baseUrl}/betweensystems/favicon.ico</icon>
${posts.map(post => `  <entry>
    ...
    <summary type="html"><![CDATA[${post.excerpt || post.content?.slice(0, 300) || 'Read more about where technology meets curiosity.'}]]></summary>
    <author>
      <name>BetweenSystems</name>
      <uri>${baseUrl}</uri>
    </author>
