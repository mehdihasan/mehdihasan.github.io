    ...
    getProfileDetails: function() {
        ...
        return  <div>
                  ...
                  <ul className="list-unstyled contact-links text-center">
                    <li><i className="fa fa-lg fa-location-arrow"></i>{profile.location.address}, {profile.location.postalCode} {profile.location.city}, {profile.location.region}</li>
                    <li><i className="fa fa-lg fa-envelope"></i><a href="mailto:{profile.email}">{profile.email}</a></li>
                  </ul>
                  <div className="divider"></div>
                  <ul className="profileLinks list-inline text-center">
                    <li><a className="fa fa-linkedin fa-2x" href={'https://twitter.com/'+profile.profiles[0].username}></a></li>
